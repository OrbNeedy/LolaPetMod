...
namespace LolaPet.Content.Lola
{
    public class LolaPetProjectile :ModProjectile
    {
        ...
        private Vector2 wingOffset = new Vector2(72, 58); // 60, 58
        ...
        private const string ultraRoute = "LolaPet/Content/Lola/UltraStyles/UltraLola";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            wingOffset = new Vector2(72, 58);
            wingPosition = Projectile.position + new Vector2(18, 19);
        ...
        private void DrawColoredSphere(Color lightColor, SpriteEffects flipping, float alpha = 1)
        {
            ...
            int flipValue = 0;
            if (flipping == SpriteEffects.FlipHorizontally && PetStyle.HologramStyle[currentIndex].Item3)
            {
                flipValue = 1;
            }
            Main.EntitySpriteDraw(
        ...
        private void DrawUltraMode(Color lightColor, SpriteEffects flipping, float alpha = 1)
        {
            Main.EntitySpriteDraw(
                ...
                new Rectangle(0, 118 * wingFrame, 132, 118),
                lightColor,
                0,
                wingOffset,
                Projectile.scale,
